...
This work was based on work done by the user JonnyTung123. The proposed strategy uses dual cointegration test using both ADF and Johansen trace test to select trading pairs - meant to improve robustness.
